        ...
        <article class="entrada-blog"> <!-- Cuando se tenga una entrada de blog -->
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    ...
                    <p>
                        Obtén inspiración y consejos prácticos para renovar tu hogar con estilo.
                    </p>
                </a>
            </div>
        </article>
        ...
        <article class="entrada-blog"> <!-- Cuando se tenga una entrada de blog -->
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    ...
                    <p>
                        Desde la elección de colores y muebles hasta la disposición inteligente del espacio.
                    </p>
                </a>
            </div>
        </article>
